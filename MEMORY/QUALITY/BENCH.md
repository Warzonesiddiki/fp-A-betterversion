...
| --- | --- | --- | --- |
| Money-AST safety | 81.44% (710 safe / 163 unsafe modules, 421 unsafe ops) | `node scripts/money-ast-detector.mjs` | 2026-08-18 (post-022) |
| Fabrication findings | 32 across 13 files | `node scripts/fabrication-detector.mjs` | 2026-08-18 (post-022) |
