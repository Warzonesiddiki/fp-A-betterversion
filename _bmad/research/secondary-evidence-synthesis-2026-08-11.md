...
1. **A-01 remains open but testable**: the public market band is $60K/yr (mid) to $500K–2M+ implementations (enterprise). R-02 must capture *participant* spend/approval thresholds, not rely on these ranges.
