...
**BMAD v5.0 Reasoning & Quality Addon activated (owner direction):** `_bmad/BMAD_V5_REASONING_QUALITY_ADDON.md` created and linked from the v5 charter; PoT/RDS/quality-gates apply to every artifact from this point. |
