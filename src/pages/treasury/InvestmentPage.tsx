            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-slate-700">
                  ...
                  <th className="text-left py-2 px-3 text-slate-400 font-medium">Issuer</th>
                  <th className="text-left py-2 px-3 text-slate-400 font-medium">Maturity</th>
                  <th className="text-right py-2 px-3 text-slate-400 font-medium">Yield</th>
                  <th className="text-right py-2 px-3 text-slate-400 font-medium">Value</th>
                  <th className="text-right py-2 px-3 text-slate-400 font-medium">Rating</th>
                </tr>
              </thead>
              <tbody>
                {INVESTMENTS.map((inv) => (
