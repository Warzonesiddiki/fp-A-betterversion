...
import PropertyPortfolioPage from '@/pages/realestate/PropertyPortfolioPage';

function renderPage() {
  return render(
    <MemoryRouter initialEntries={['/realestate/portfolio']}>
      <PropertyPortfolioPage />
    </MemoryRouter>
  );
}

describe('PropertyPortfolioPage smoke test', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
