...
export default function AgricultureDashboardPage() {
  ...
  if (entries.length === 0) {
    return (
      <main className="p-12 text-center" role="main" aria-label="Agriculture Dashboard - No Data">
        <Wheat className="h-10 w-10 text-slate-400 mx-auto mb-4" />
        <h2 className="text-xl font-semibold mb-2">Agriculture — No Data</h2>
        <p className="text-slate-400 mb-6">Import GL data to view agriculture KPIs.</p>
  ...
  return (
    <main className="p-6 space-y-6" role="main">
      ...
      <p className="text-sm text-slate-400">Crop production, livestock, and agribusiness metrics</p>
          ...
          <CardContent>
            <div className="space-y-3">
              <div className="flex justify-between items-center">
                <span className="text-sm text-slate-400">Yield per Hectare</span>
                <span className="font-mono">8.5 tons</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-sm text-slate-400">Revenue per Acre</span>
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-3">
              ...
              <div className="flex justify-between items-center">
                <span className="text-sm text-slate-400">Cost per Unit</span>
