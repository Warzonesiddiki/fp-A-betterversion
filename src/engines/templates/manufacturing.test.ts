...
import { buildManufacturingTemplate } from './manufacturing';

describe('Manufacturing Template', () => {
  describe('buildManufacturingTemplate', () => {
    it('returns a valid template', () => {
      const template = buildManufacturingTemplate();
