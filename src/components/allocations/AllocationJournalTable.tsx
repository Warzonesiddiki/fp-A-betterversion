...
export const AllocationJournalTable = memo(function AllocationJournalTable({
  ...
  return (
    ...
    >
      <table className="w-full" aria-label="Allocation journal entries: period, amount, status, description">
        <thead>
          <tr className="border-b border-[var(--border-subtle)] bg-[var(--bg-elevated)]">
            <th scope="col" className="px-3 py-2 text-left text-[10px] font-medium text-slate-500 uppercase">
              Account
            </th>
            <th scope="col" className="px-3 py-2 text-right text-[10px] font-medium text-slate-500 uppercase">
              Debit
            </th>
            <th scope="col" className="px-3 py-2 text-right text-[10px] font-medium text-slate-500 uppercase">
              Credit
