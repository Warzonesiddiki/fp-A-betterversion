              ...
              {editingIdx === idx ? (
                ...
                <>
                  ...
                  <button
                    ...
                    className="absolute top-2 right-2 opacity-0 group-hover:opacity-100 text-[var(--text-muted)] hover:text-slate-300 p-1 rounded hover:bg-slate-700 transition-opacity"
