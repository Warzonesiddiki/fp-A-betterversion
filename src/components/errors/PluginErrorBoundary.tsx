...
export class PluginErrorBoundary extends Component<Props, State> {
  ...
  render(): ReactNode {
    if (this.state.hasError) {
      return (
        <div className="flex flex-col items-center justify-center p-4 border border-orange-200 rounded-lg bg-orange-50 dark:bg-orange-950 dark:border-orange-800">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="flex items-center gap-1 px-2 py-1 text-xs text-orange-700 border border-orange-300 rounded hover:bg-orange-100"
            >
              <RefreshCw className="w-3 h-3" /> Retry
            </button>
            <button
              onClick={this.handleDisable}
              className="flex items-center gap-1 px-2 py-1 text-xs text-red-700 border border-red-300 rounded hover:bg-red-100"
            >
