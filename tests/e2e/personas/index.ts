...
export const PERSONA_ALIAS_MAP = {
  'cfo-enterprise': {
    journeys: ['01-import-data', '02-multi-scenario', '03-period-close'],
    tests: 3,
  },
  ...
  'sector-healthcare': {
    journeys: ['08-temporal-edge-cases', '09-cross-muse-integration'],
    tests: 2,
  },
  'sector-real-estate': {
    journeys: ['02-multi-scenario', '04-variance-analysis', '06-backup-restore'],
    tests: 3,
  },
  'sector-real-estate-irr': { journeys: ['04-variance-analysis'], tests: 1 },
  'sector-telecom': {
    journeys: ['02-multi-scenario', '04-variance-analysis', '07-plugin-sandbox'],
    tests: 3,
  },
