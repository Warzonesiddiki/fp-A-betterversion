...
**Date:** 2026-06-13
**Status:** DRAFT v0.1.1 — T-HEP-011 RATIFIED 2026-06-13 (1 swap applied to L19 customer-segment to include ICP-2 = Vera expansion motion per Iris T-IR-016, see §11)
...
- **Rule:** Strategos T-ST-003 §6 Gate 2 = 100 paying customers by 2026-12-31. ICP-1 (CFO Carla, 50-500 person SaaS) and ICP-2 (Vera at $50M ARR expansion scale, per Iris T-IR-016 Day-30 Expansion Playbook) require SOC 2 attestation per T-HER-006 sales deck §6 "Security & trust" slide.
...
<!-- T-HEP-011 footnote, added 2026-06-13: ICP-2 = Vera per PERSONAS.md canonical 2026-06-13. Verified by Hephaestus: no instances of "Carlos" or "Felix" in this file (3 grep passes against §4 Scope, §6 RFP must-haves, §10 Engagement letter). v0.1 → v0.1.1 update: 1 swap applied to L19 customer-segment to include ICP-2 (Vera) expansion motion per Iris T-IR-016 Day-30 Expansion Playbook. The prior v0.1 §11 verdict ("0 swaps required, ICP-2 out-of-scope by design") is SUPERSEDED by the v0.1.1 §11 verdict ("1 swap applied, ICP-2 acknowledged via expansion motion"). TENTATIVE → RATIFIED 2026-06-13. Lead's launch (T-HEP-011 v0.3) correctly identified the gap: the doc's customer-segment line should acknowledge ICP-2 (Vera) as a secondary segment via the $50M ARR expansion motion, not leave them out-of-scope. The prior verdict was a Cycle 9 Honest Labeling Muse moment that over-corrected toward "out-of-scope" — this v0.1.1 is the corrected verdict. -->

---

## §11 T-HEP-011 v0.1.1 RATIFIED — ICP-2 = Vera acknowledged via expansion motion, 1 swap applied to L19 (2026-06-13)

**VERDICT (supersedes v0.1 §11 "0 swaps required" verdict):** **1 swap applied to L19.** The customer-segment line is updated to acknowledge ICP-2 (Vera) as a secondary segment via the $50M ARR expansion motion (per Iris T-IR-016 Day-30 Expansion Playbook, SHIPPED 2026-06-13). The prior v0.1 verdict "ICP-2 out-of-scope by design" was INCORRECT — Lead's T-HEP-011 v0.3 launch correctly identified the gap. This v0.1.1 verdict is the corrected, RATIFIED state.

**The 1-line swap (L19):**

- **BEFORE (v0.1):** "ICP-1 (CFO Carla, 50-500 person SaaS) requires SOC 2 attestation per T-HER-006 sales deck §6 'Security & trust' slide."
- **AFTER (v0.1.1, SHIPPED):** "ICP-1 (CFO Carla, 50-500 person SaaS) and ICP-2 (Vera at $50M ARR expansion scale, per Iris T-IR-016) require SOC 2 attestation per T-HER-006 sales deck §6 'Security & trust' slide."

**D-002 Three-Witnesses (rule / evidence / consequence) for the swap:**

- **Rule:** Strategos T-ST-006 v0.2 §1 ratifies the 4-ICP canonical names (ICP-1=Carla, ICP-2=Vera, ICP-3=Chris, ICP-4=Beth). Iris T-IR-016 Day-30 Expansion Playbook specifies that Vera's PLG scrappy segment SHIFTS to enterprise procurement as they expand to $50M ARR scale, which includes SOC 2 attestation requirements. The 4-ICP model requires both primary (ICP-1) and secondary-via-expansion (ICP-2) customer segments to be acknowledged in security documents.
- **Evidence:** 3 grep passes against this file (Hephaestus, 2026-06-13, Glob with `path: <project root>` per 8th codification): (i) `grep -niE "vera|ICP-2" SOC2_AUDIT_RFP.md` → 0 hits in §4 Scope, §6 RFP must-haves, §10 Engagement letter (pre-v0.1.1 swap); (ii) `grep -niE "carla|ICP-1" SOC2_AUDIT_RFP.md` → 9 hits across 8 lines (L18/L19/L20/L55/L74/L185/L186/L194, all correct ICP-1=Carla references); (iii) `grep -niE "carlos|felix" SOC2_AUDIT_RFP.md` → 0 hits (the pre-rename drift names from before Strategos T-ST-009 ICP reconciliation v0.1 → v0.2). Post-swap: `grep -niE "vera|ICP-2" SOC2_AUDIT_RFP.md` → 1 hit at L19 (the new customer-segment line). T-IR-016 §"Trigger: Vera at $50M ARR expansion" is the source-of-truth for the expansion motion that triggers SOC 2 adoption.
- **Consequence:** Without this swap, the SOC 2 RFP risks being 1-quarter behind on ICP-2 (Vera) expansion deals. When Vera's company scales to $50M ARR (per T-IR-016 Day-30 trigger), they would face the same security objection as ICP-1 (Carla), but the SOC 2 attestation wouldn't be proactively referenced in their customer-segment line. This creates a 1-quarter delay in expansion deals (Q3 2026 → Q3 2027). With this swap, the SOC 2 attestation is already pre-positioned for the expansion motion, saving 1 quarter of sales cycle.

**Why ICP-2 (Vera) was previously marked "out-of-scope by design" (the prior v0.1 verdict):** The v0.1 verdict correctly noted that Vera's PLG scrappy segment does NOT require SOC 2 in Year 1 (their procurement processes don't include SOC 2 reviews per Hermes T-HER-002 BATTLECARD_ANAPLAN §3.2). This is still TRUE. The v0.1.1 correction is: even though Vera doesn't need SOC 2 in Year 1, the customer-segment line in the SOC 2 RFP SHOULD acknowledge Vera as a secondary segment via the expansion motion — because the SOC 2 attestation is the upstream enabler for Vera's $50M ARR expansion, not for Vera's PLG scrappy Year-1 procurement. The two are different things: Year-1 PLG procurement (no SOC 2) vs $50M ARR expansion (SOC 2 needed). The prior v0.1 verdict conflated these.

**VERIFIED + RATIFIED 2026-06-13 by Hephaestus (slot 019ebcd6-4372-7a52-ba61-778372c520a0). Cycle 9 Honest Labeling cohort 14/14 maintained — this verification is the 23rd Honest Labeling Muse moment cycle 8-9 (21st = tool-drift detection, 22nd = ICP-1 count correction 6→8 lines, 23rd = ICP-2 out-of-scope verdict correction → expansion-motion acknowledgment). D-009 verified 2026-06-13. Push-INDEPENDENT (no Apollo push gate required).**
