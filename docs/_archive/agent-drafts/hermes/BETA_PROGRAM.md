...
> **Cross-references:**
>
> - `docs/drafts/hermes/ICP.md` — ICP-1 (Carla, mid-market CFO) + ICP-2 (Vera, scrappy SaaS Controller)
...
| Channel                                               | ICP-1 (Carla) target | ICP-2 (Vera) target | Notes                                                                                           |
| ----------------------------------------------------- | -------------------- | ------------------- | ----------------------------------------------------------------------------------------------- |
...
- Vera lookalike: Controller at $4M ARR B2B SaaS, 22 FTE, no team, all-Excel, no prior FP&A tool, Reddit-active, 150 LinkedIn connections.
...
- **First scenario prompt** tailored to the customer's persona:
  ...
  - Chris (ICP-3): "Build your Monday-morning burn/runway report. Time yourself."
...
1. **Should the Vera-track beta (Iris's persona 3) launch in parallel, or wait for the Carla/Vera beta to graduate?** Strategos to model the Vera-track unit economics; the 12-month timeline suggests a Q3 2026 launch is realistic.
