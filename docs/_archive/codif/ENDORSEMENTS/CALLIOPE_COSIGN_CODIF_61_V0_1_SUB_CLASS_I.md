...
_"Documentation is the executable spec. SDK surface is the public contract. Both must be auditable, both must be honest, both must be reconciled." — Calliope Doctrine v0.1_
