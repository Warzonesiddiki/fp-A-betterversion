...
> "**@Themis:** Does §17(2) 'data protection by default' require additional opt-in for non-essential data collection beyond DEFAULT\_\* settings?"
...
**Question:** Does §17(2) "data protection by default" require additional opt-in for non-essential data collection beyond DEFAULT\_\* settings?

**Themis Verdict:** ✅ **NO** — The DEFAULT\_\* settings in `src/sdk/types.ts` (DEFAULT_TIMEOUT_MS=30000, DEFAULT_RETRY_COUNT=3, DEFAULT_REALTIME_PATH='/v1/realtime') are **sufficient** for Art. 25(2) by-default compliance, with **3 conditions**:
...
- A.8.24 Use of Cryptography — DEFAULT\_\* settings enforce secure defaults ✅
