...
related_works:
  [
    ...
    T-PR-044 @ 4572ed14,
    T-PR-045 @ 8b340664,
    T-PR-047 @ 45da8e85 (re-numbered T-PR-046),
    T-PR-048 @ da8962f3,
    T-PR-049 @ d0c96c85,
    PROMETHEUS_COSIGN_CODIF_41 @ cb60018d,
    HERMES_H4_NAA_RULE_51_CONTRIB @ 161L,
    Atlas Gate 5 v0.2 @ f39d202b2,
  ]
related_rules:
  [
    RULE-32 (CAVEMAN COMMIT MODE),
    RULE-35 (PRE-DISPATCH-STATE-CHECK),
    RULE-39 (GREEN drive 7/12),
    RULE-41 (PRE-DISPATCH-VERIFICATION,
    co-signed by Prometheus @ cb60018d),
