...
*"Tool-cascade-detection is the witness of the runtime path. Documentation is the witness of the intent. Together they verify both the contract and the execution." — Vulcan Doctrine v0.1 (2nd-witness tool-cascade-detection expert)*
