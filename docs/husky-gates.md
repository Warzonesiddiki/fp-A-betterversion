...
dri_by_gate: { Gate 5: Atlas, Gate 5b: Atlas, Gate 5c: Atlas, Gate 9: Atlas + Prometheus, Gate 10: Atlas + Hephaestus }
...
| **Gate 10** | NEVER-AGAIN RULE #68 CASCADE-HOLD-BUNDLE Auto-Detection | Atlas + Hephaestus | Hephaestus | CATCH #207 #4 | TBD (CYCLE 15 PICK A) |
