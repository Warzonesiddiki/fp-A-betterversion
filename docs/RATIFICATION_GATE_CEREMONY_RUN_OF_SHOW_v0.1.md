...
This RUN-OF-SHOW is the **operational execution script** for the RATIFICATION GATE ceremony — distinct from RUNBOOK v0.2 (which codifies *criteria*) and PRECHECK_INDEX v0.7.2 (which tracks *pre-ceremony completion*). This document codifies the *minute-by-minute walkthrough* including:
