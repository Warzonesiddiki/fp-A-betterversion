...
All figures are *target* ranges, not commitments. Currency: USD. ARR = annual recurring revenue. MRR = monthly recurring revenue. Pilot = pre-paying design partner.
...
|---|---|---|---|
| **Founder** | All of it; this is *their* roadmap | Weekly 1:1 with Strategos | In-person / video |
